...
-1 .ml.ptree[0] tr:.ml.ct[2;0W;::] wdbc.t;
-1 "building a classification tree (a la quinlan)";
-1 .ml.ptree[0] tr:.ml.q45[2;0W;::] wdbc.t; / quinlan classification tree
-1 "pruning tree";
-1 .ml.ptree[0] .ml.prune[.ml.perr[neg .qml.nicdf .000001]] tr;
-1 "splitting train/test";
d:`train`test!.ml.part[3 1] wdbc.t
-1 "growing a random forest";
m:.ml.rfo[10;floor sqrt count cols d`train;.ml.ct[2;0W;::]] d`train
