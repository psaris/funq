...
/movie:1!update `u#movieId from ("I*";1#",") 0:`$f,"/movies.csv";
...
-1"we can also see that a large majorit of movies have less than 10 ratings";
...
r,:([]movieId:4006 53996 69526 87520 112370 86898i;rating:5 4 4 3 2 .5)
