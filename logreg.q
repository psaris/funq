...
theta:first .fmincg.fmincg[1000;.ml.logcostgrad[binary.X;binary.Y];theta]

/ compare plots
show plt binary.X,binary.Y;
show plt binary.X,p:.ml.lpredict[binary.X] enlist theta;
